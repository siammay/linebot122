local file = assert(load(gg.makeRequest('https://raw.githubusercontent.com/cagarcahya/JOYs/master/JOYs%20V8.9.9%20VVIP%20for%20PUBGM%200.8.1.loader.lua').content))
pcall(file)
function Main()
menu1 = gg.choice({ 
' ☢ บายพาสใหม่☢',
...
gg.searchNumber("1.2F;1.8F:9::1",gg.TYPE_DOUBLE, false,gg.SIGN_EQUAL, 0, -1) 
gg.searchNumber("1.1F;1.4F:3::1",gg.TYPE_DOUBLE, false,gg.SIGN_EQUAL, 0, -1) gg.searchNumber("1.1D;1.4D:2::10",gg.TYPE_DOUBLE, false,gg.SIGN_EQUAL, 0, -1)
gg.toast('บายพาสใหม่100%') 
gg.alert(os.date("Hoje: %Y/%m/%d Hora: %H:%M:%S\nเริ่มใช้สลิปได้เลย 👍"))
BP=0
  end
...
'🇹🇭สีปืน(ล็อบปี้)🇹🇭',
'🇹🇭ล็อคเป๋า👓🇹🇭',
'🇹🇭กระสุนติดตาม+ล็อกหัว🇹🇭',
"[🇹🇭ย้อนกลับ🇹🇭]"
},nil,'ผึ้งน้อยVIP 2.9')
if MN2 == nil then
else
    if MN2 == 1 then WHM() end
    if MN2 == 2 then NGT() end
    if MN2 == 3 then A2() end
    if MN2 == 4 then AB() end
    if MN2 == 5 then AB1() end
    if MN2 == 6 then Main() end
  end
  PUBGMH = -1
  end
  function WHM()
SKL3 = gg.multiChoice({
	...
	'🚷สีขาว(MTK)',
	"[ย้อนกลับ]"
  }, nil, "สลิปVIPผึ้งน้อย 2.8.1")
    if SKL3 == nil then else
    if SKL3[1] == true then wh425() end
    if SKL3[2] == true then wh625() end 
    if SKL3[3] == true then wh660() end 
    if SKL3[4] == true then wh835() end
    if SKL3[5] == true then wh845() end
    if SKL3[6] == true then MTK() end
    if SKL3[7] == true then RBC() end
    if SKL3[8] == true then CLR() end
    if SKL3[9] == true then CLO() end
    if SKL3[10] == true then CB() end
    if SKL3[11] == true then cwhite() end
    if SKL3[12] == true then cblack() end
    if SKL3[13] == true then green() end
    if SKL3[14] == true then green1() end
    if SKL3[15] == true then CLMTK() end
    if SKL3[16] == true then Main() end  
    end
    PUBHMH = -1
    end 
    function NGT()
SKL3 = gg.multiChoice({
'😠ลดดีดสูงสุดครั้งที่1😠',
'😃ลดดีดสูงสุดครั้งที่2😃',
'🙏✅ลดดีดใหม่✅ใช้ตอนได้ปืนแล้ว🙏',
'💣ลดดีดสูงสุด💣(ได้ปืนแล้ว)',
'🙄ล็อกหัว+กระสุนติดตาม (90% - 100%)[ล็อบปี้]😊',
'✒เสาอากาศใหม่V3 [ในเกมส์]✒',
'🌡เสาอากาศเสมอ [ในเกมส์]🌡',
'💯เปลี่ยนเป๋า (ในเกมส์)💯',
'🚶ซ่อนรอยเท้าเรา (ในเกมส์)🚶',
'⚽ไม่มีหญ้า [ในเกมส์]⚽',
'🕹นั่งยิงสูง 《เปิด ',
'🕹นั่งยิงสูง 《ปิด',
'🍗ลูกกระสุนทะลุ(ล็อบปี้)🍗',
'🌚ฟ้ามืด🌑',
'🚷ลบหญ้า+ต้นไม้(แผนที่ไทย)',
"[ย้อนกลับ]"
  }, nil, " สลิปVIP 2.8.1ผึ้งน้อย")
    if SKL3 == nil then else
    if SKL3[1] == true then norecoil1() end
    if SKL3[2] == true then norecoil() end
    if SKL3[3] == true then norecoil3() end
    if SKL3[4] == true then NRCC() end
    if SKL3[5] == true then hs() end
    if SKL3[6] == true then antena() end
    if SKL3[7] == true then antena1() end
    if SKL3[8] == true then scrosshair() end
    if SKL3[9] == true then hiden() end
    if SKL3[10] == true then grass() end
    if SKL3[11] == true then lsda() end
    if SKL3[12] == true then lsdao() end
    if SKL3[13] == true then BTT() end
    if SKL3[14] == true then SPP() end
    if SKL3[15] == true then Rem1() end
    if SKL3[16] == true then Main() end    
    end
    PUBHMH = -1
    end
...
SKL3 = gg.multiChoice({
	...
	'🔫98K สีรวม✅',
	"[ย้อนกลับ]"
  }, nil, "เครดิต สลิปVIP 2.8.1ผึ้งน้อย")
    if SKL3 == nil then else
    if SKL3[1] == true then AK2() end
    if SKL3[2] == true then SC1() end
    if SKL3[3] == true then MS1() end
    if SKL3[4] == true then MYL1() end
    if SKL3[5] == true then MYL2() end
    if SKL3[6] == true then UP1() end 
    if SKL3[7] == true then UP2() end
    if SKL3[8] == true then BK1() end 
    if SKL3[9] == true then Main() end       
    end
    PUBHMH = -1
	end
function AB()
SKL3 = gg.multiChoice({
'👒ล็อคเป๋า100เมตร(หลังจากได้ปืน)',
'🏋ล็อคเป๋าขั้นสุด(ปืนที่ใส่คูณ8ได้)',
'🌡ล็อคเป๋ากลาง🌡',
"[ย้อนกลับ]"
}, nil, "เครดิต สลิปVIP 2.8ผึ้งน้อย")
    if SKL3 == nil then else
    if SKL3[1] == true then MEDAIM() end 
    if SKL3[2] == true then ultraUAI() end
    if SKL3[3] == true then mediumAIM() end
    if SKL3[4] == true then Main() end
    end
    PUBHMH = -1
	end
function AB1()
...
'🚷ล็อกหัว99%',
"[ย้อนกลับ]"
}, nil, "สลิปVIP2.8.1ผึ้งน้อย")
    if SKL3 == nil then else
    if SKL3[1] == true then MG() end 
    if SKL3[2] == true then BLTK() end
    if SKL3[3] == true then HM80() end
    if SKL3[4] == true then AHN() end
    if SKL3[5] == true then HEADSHOOT99AIMV2() end
    if SKL3[6] == true then Main() end
    end
    PUBHMH = -1
	end
...
gg.getResults(4)
gg.editAll("120", gg.TYPE_FLOAT)
gg.toast("เปิดมองทะลุ425+แล้ว] Activated")
end 
    
    function wh625() 
    gg.toast("เปิดมองทะลุ625+ รอสักครู่.....")
gg.clearResults()
gg.setRanges(gg.REGION_BAD)
...
gg.toast("เปิดมองทะลุ 845 แล้ว")
  ...
  gg.clearResults()
  gg.toast("การเปิดใช้งานที่ประสบความสำเร็จ")
  end
function RBC()
  gg.clearResults()
  gg.setRanges(gg.REGION_BAD)
...
gg.clearResults()
gg.toast("เปิดใช้งาน EXTREME HS แล้ว")
end
function antena()
...
function antena1()
  ...
  gg.editAll("19995", gg.TYPE_FLOAT)
  gg.clearResults()
  gg.toast("เสาอากาศ ใช้งานตลอดเวลา")
end
function scrosshair()
  gg.clearResults()
...
gg.clearResults()
gg.alert("ล็อกเป๋าแล้ว [ ผึ้งน้อย 🇹🇭 ]")
  end
...
gg.editAll("88.6668", gg.TYPE_FLOAT)
gg.clearResults()
gg.toast("ความสำเร็จในการติดตามหัวข้อย่อย")
    end 
...
gg.editAll("0.07", gg.TYPE_FLOAT)
gg.clearResults()
gg.toast("ล็อกหัว95%แล้ว [ 🇹🇭🇹🇭🇹🇭]")
end

function HEADSHOOT99AIMV2()
gg.setRanges(gg.REGION_BAD)
gg.searchNumber("-88.66608428955;26:512", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("26", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
gg.getResults(2)
...
function Exit()
gg.toast("สลิปผึ้งน้อยVIP ")
print('เลือกใช้โปรอย่างเหมาะสม')
print('ไลน์ไอดี klkl151')
os.exit()
end
